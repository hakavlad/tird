...
`tird` /tɪrd/ *(an acronym for "this is random data")* is a file encryption tool focused on <ins>minimizing metadata</ins> and <ins>hiding encrypted data</ins>.
...
The author pronounces `tird` as /tɪrd/.
