...
**Function:** `get_processed_comments()`
...
**Valid values:** from 0 to 2^64  (up to 16 EiB)
...
**Valid values:** from `0` to input/output file size; depends on context
...
**Default value:** not defined for actions `5|7`, `output_file_size` for action `9`
...
**Function:** `collect_and_handle_ikm()`
...
**Valid values:** arbitrary string from 1 byte, or none
